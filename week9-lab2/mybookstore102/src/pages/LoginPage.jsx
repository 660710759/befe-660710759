...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-400 to-green-700 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-16 w-16 bg-white rounded-full flex items-center justify-center">
            <LockClosedIcon className="h-10 w-10 text-sky-400" />
          </div>
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent
                  rounded-lg shadow-sm text-sm font-medium text-white bg-sky-400
        ...
        <div className="text-center">
          <a href="/" className="text-sm text-white hover:text-sky-400 transition-colors">
            ← กลับสู่หน้าแรก
          </a>
        </div>
      </div>
